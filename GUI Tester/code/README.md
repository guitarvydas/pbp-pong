# Test Jig for Visualizing Ball Motion
# usage
`> node test-daemon.js` in one terminal
use a browser to open `client.html`
use `./send-command` as described below to send commands to the GUI
