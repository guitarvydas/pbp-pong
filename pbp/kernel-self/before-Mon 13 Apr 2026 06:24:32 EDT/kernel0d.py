...
class Eh:
    def __init__ (self,):                              #line 539
        ...
        self.retcode =  "ok"                           #line 556
        self.special =  False                          #line 557# bootstrap debugging#line 558
        self.kind =  None # enum { container, leaf, }  #line 559#line 560
                                                       #line 561
# Creates a component that acts as a container. It is the same as a `Eh` instance#line 562
# whose handler function is `container_handler`.       #line 563
def make_container (name,owner):                       #line 564
    eh =  Eh ()                                        #line 565
    eh.name =  name                                    #line 566
    eh.owner =  owner                                  #line 567
    eh.handler =  container_handler                    #line 568
    eh.finject =  injector                             #line 569
    eh.stop =  container_reset_children                #line 570
    eh.state =  "idle"                                 #line 571
    eh.kind =  "container"                             #line 572
    return  eh                                         #line 573#line 574#line 575

# Creates a new leaf component out of a handler function, and a data parameter#line 576
# that will be passed back to your handler when called.#line 577#line 578
def make_leaf (name,owner,instance_data,arg,handler,reset_handler):#line 579
    eh =  Eh ()                                        #line 580
    nm =  ""                                           #line 581
    if  None!= owner:                                  #line 582
        nm =  owner.name                               #line 583#line 584
    eh.name =  str( nm) +  str( "▹") +  name           #line 585
    eh.owner =  owner                                  #line 586
    eh.handler =  handler                              #line 587
    eh.reset_handler =  reset_handler                  #line 588
    eh.finject =  injector                             #line 589
    eh.stop =  leaf_reset                              #line 590
    eh.instance_data =  instance_data                  #line 591
    eh.arg =  arg                                      #line 592
    eh.state =  "idle"                                 #line 593
    eh.kind =  "leaf"                                  #line 594
    return  eh                                         #line 595#line 596#line 597

# Reset Leaf part to a known, idle state. Hit the big red button. #line 598
def leaf_reset (part):                                 #line 599

    part.inq.clear ()                                  #line 600

    part.outq.clear ()                                 #line 601
    if ( part.reset_handler!= None):                   #line 602
        part.reset_handler ( part)                     #line 603#line 604
    part.state =  "idle"                               #line 605#line 606#line 607

# Sends a mevent on the given `port` with `data`, placing it on the output#line 608
# of the given component.                              #line 609#line 610
def send (eh,port,obj,causingMevent):                  #line 611
    d =  Datum ()                                      #line 612
    d.v =  obj                                         #line 613
    d.clone =  lambda : obj_clone ( d)                 #line 614
    d.reclaim =  None                                  #line 615
    mev = make_mevent ( port, d)                       #line 616
    put_output ( eh, mev)                              #line 617#line 618#line 619

def forward (eh,port,mev):                             #line 620
    fwdmev = make_mevent ( port, mev.datum)            #line 621
    put_output ( eh, fwdmev)                           #line 622#line 623#line 624

def inject_mevent (eh,mev):                            #line 625
    eh.finject ( eh, mev)                              #line 626#line 627#line 628
...
def put_output (eh,mev):                               #line 637
    eh.outq.append ( mev)                              #line 638#line 639#line 640

def obj_clone (obj):                                   #line 641
    return  obj                                        #line 642#line 643#line 644

def initialize_component_palette_from_files (diagram_source_files):#line 645
    reg = make_component_registry ()                   #line 646
    for diagram_source in  diagram_source_files:       #line 647
        all_containers_within_single_file = lnet2internal_from_file ( diagram_source)#line 648
        for container in  all_containers_within_single_file:#line 649
            register_component ( reg,mkTemplate ( container [ "name"], container, container_instantiator))#line 650#line 651#line 652
    initialize_stock_components ( reg)                 #line 653
    return  reg                                        #line 654#line 655#line 656

def initialize_component_palette_from_string (lnet):   #line 657
    reg = make_component_registry ()                   #line 658
    all_containers = lnet2internal_from_string ( lnet) #line 659
    for container in  all_containers:                  #line 660
        register_component ( reg,mkTemplate ( container [ "name"], container, container_instantiator))#line 661#line 662
    initialize_stock_components ( reg)                 #line 663
    return  reg                                        #line 664#line 665#line 666
                                                       #line 667
def clone_string (s):                                  #line 668
    return  s                                          #line 669#line 670#line 671

load_errors =  False                                   #line 672
runtime_errors =  False                                #line 673#line 674
def load_error (s):                                    #line 675
    global load_errors                                 #line 676
    print ( s, file=sys.stderr)                        #line 677
                                                       #line 678
    load_errors =  True                                #line 679#line 680#line 681

def runtime_error (s):                                 #line 682
    global runtime_errors                              #line 683
    print ( s, file=sys.stderr)                        #line 684
    exit (1)                                           #line 685
    runtime_errors =  True                             #line 686#line 687#line 688
                                                       #line 689
def initialize_from_files (diagram_names):             #line 690
    arg =  None                                        #line 691
    palette = initialize_component_palette_from_files ( diagram_names)#line 692
    return [ palette,[ diagram_names, arg]]            #line 693#line 694#line 695

def initialize_from_string ():                         #line 696
    arg =  None                                        #line 697
    palette = initialize_component_palette_from_string ()#line 698
    return [ palette,[ None, arg]]                     #line 699#line 700#line 701

def start (arg,part_name,palette,env):                 #line 702
    part = start_bare ( part_name, palette, env)       #line 703
    inject ( part, "", arg)                            #line 704
    finalize ( part)                                   #line 705#line 706#line 707

def start_bare (part_name,palette,env):                #line 708
    diagram_names =  env [ 0]                          #line 709
    # get entrypoint container                         #line 710
    part = get_component_instance ( palette, part_name, None)#line 711
    if  None ==  part:                                 #line 712
        load_error ( str( "Couldn't find container with page name /") +  str( part_name) +  str( "/ in files ") +  str(str ( diagram_names)) +  " (check tab names, or disable compression?)"    )#line 716#line 717
    return  part                                       #line 718#line 719#line 720

def inject (part,port,payload):                        #line 721
    if not  load_errors:                               #line 722
        d =  Datum ()                                  #line 723
        d.v =  payload                                 #line 724
        d.clone =  lambda : obj_clone ( d)             #line 725
        d.reclaim =  None                              #line 726
        mev = make_mevent ( port, d)                   #line 727
        inject_mevent ( part, mev)                     #line 728
    else:                                              #line 729
        exit (1)                                       #line 730#line 731#line 732#line 733

def finalize (part):                                   #line 734
    print ( "finalize A", file=sys.stderr)             #line 735
    print (deque_to_json ( part.outq))                 #line 736
    print ( "finalize B", file=sys.stderr)             #line 737
    if ( part.retcode ==  "failed"):                   #line 738
        print ( "finalize C", file=sys.stderr)         #line 739
        exit (1)                                       #line 740#line 741
    print ( "finalize D", file=sys.stderr)             #line 742#line 743#line 744

def new_datum_bang ():                                 #line 745
    d =  Datum ()                                      #line 746
    d.v =  "!"                                         #line 747
    d.clone =  lambda : obj_clone ( d)                 #line 748
    d.reclaim =  None                                  #line 749
    return  d                                          #line 750#line 751
...
def fail_with_error_instantiate (reg,owner,name,template_data,arg):#line 291
    name_with_id = gensymbol ( "Fail_With_Error")      #line 292
    inst =  None                                       #line 293
    return make_leaf ( name_with_id, owner, inst, "", fail_with_error_handler, None)#line 294#line 295#line 296

def fail_with_error_handler (eh,mev):                  #line 297
    inst =  eh.instance_data                           #line 298
    parent =  eh.owner                                 #line 299
    s =  str( "   !!! fail_with_error: '") +  str( parent.name) +  "'"  #line 300
    print ( s, file=sys.stderr)                        #line 301
                                                       #line 302
    eh.retcode =  "failed"                             #line 303
    # for debug - this should fail with dropped on floor #line 304
    send ( eh, "", mev.datum.v, mev)                   #line 305#line 306#line 307

# all of the the built_in leaves are listed here       #line 308
# future: refactor this such that programmers can pick and choose which (lumps of) builtins are used in a specific project#line 309#line 310
def initialize_stock_components (reg):                 #line 311
    register_component ( reg,mkTemplate ( "1then2", None, deracer_instantiate))#line 312
    register_component ( reg,mkTemplate ( "1→2", None, deracer_instantiate))#line 313
    register_component ( reg,mkTemplate ( "trash", None, trash_instantiate))#line 314
    register_component ( reg,mkTemplate ( "🗑️", None, trash_instantiate))#line 315
    register_component ( reg,mkTemplate ( "🚫", None, stop_instantiate))#line 316
    register_component ( reg,mkTemplate ( "👎", None, fail_with_error_instantiate))#line 317#line 318#line 319
    register_component ( reg,mkTemplate ( "Read Text File", None, low_level_read_text_file_instantiate))#line 320
    register_component ( reg,mkTemplate ( "Ensure String Datum", None, ensure_string_datum_instantiate))#line 321#line 322
    register_component ( reg,mkTemplate ( "syncfilewrite", None, syncfilewrite_instantiate))#line 323
    register_component ( reg,mkTemplate ( "String Concat", None, stringconcat_instantiate))#line 324
    register_component ( reg,mkTemplate ( "switch1*", None, switch1star_instantiate))#line 325
    register_component ( reg,mkTemplate ( "String Concat *", None, strcatstar_instantiate))#line 326
    # for fakepipe                                     #line 327
    register_component ( reg,mkTemplate ( "fakepipename", None, fakepipename_instantiate))#line 328#line 329#line 330
