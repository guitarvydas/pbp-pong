...
def finalize (part):                                   #line 733
    print ( "finalize A", file=sys.stderr)             #line 734
    print (deque_to_json ( part.outq))                 #line 735
    print ( "finalize B", file=sys.stderr)             #line 736
    if ( part.state ==  "failed"):                     #line 737
        print ( "finalize C", file=sys.stderr)         #line 738
        exit (1)                                       #line 739#line 740
    print ( "finalize D", file=sys.stderr)             #line 741#line 742#line 743

def new_datum_bang ():                                 #line 744
    d =  Datum ()                                      #line 745
    d.v =  "!"                                         #line 746
    d.clone =  lambda : obj_clone ( d)                 #line 747
    d.reclaim =  None                                  #line 748
    return  d                                          #line 749#line 750
