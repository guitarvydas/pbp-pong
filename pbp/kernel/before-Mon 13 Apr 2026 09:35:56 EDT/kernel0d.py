...
def finalize (part):                                   #line 734
    ...
    if ( part.retcode ==  "failed"):                   #line 736
        send ( part, "👍👎", "fail", None)               #line 737
    else:                                              #line 738
        send ( part, "👍👎", "success", None)            #line 739#line 740#line 741#line 742

def new_datum_bang ():                                 #line 743
    d =  Datum ()                                      #line 744
    d.v =  "!"                                         #line 745
    d.clone =  lambda : obj_clone ( d)                 #line 746
    d.reclaim =  None                                  #line 747
    return  d                                          #line 748#line 749
