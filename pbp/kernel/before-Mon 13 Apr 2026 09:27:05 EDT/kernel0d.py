...
def finalize (part):                                   #line 734
    print (deque_to_json ( part.outq))                 #line 735
    if ( part.retcode ==  "failed"):                   #line 736
        exit (1)                                       #line 737#line 738#line 739#line 740

def new_datum_bang ():                                 #line 741
    d =  Datum ()                                      #line 742
    d.v =  "!"                                         #line 743
    d.clone =  lambda : obj_clone ( d)                 #line 744
    d.reclaim =  None                                  #line 745
    return  d                                          #line 746#line 747
...
def fail_with_error_handler (eh,mev):                  #line 297
    ...
    print ( s, file=sys.stderr)                        #line 301
                                                       #line 302
    eh.retcode =  "failed"                             #line 303#line 304#line 305

# all of the the built_in leaves are listed here       #line 306
# future: refactor this such that programmers can pick and choose which (lumps of) builtins are used in a specific project#line 307#line 308
def initialize_stock_components (reg):                 #line 309
    register_component ( reg,mkTemplate ( "1then2", None, deracer_instantiate))#line 310
    register_component ( reg,mkTemplate ( "1→2", None, deracer_instantiate))#line 311
    register_component ( reg,mkTemplate ( "trash", None, trash_instantiate))#line 312
    register_component ( reg,mkTemplate ( "🗑️", None, trash_instantiate))#line 313
    register_component ( reg,mkTemplate ( "🚫", None, stop_instantiate))#line 314
    register_component ( reg,mkTemplate ( "👎", None, fail_with_error_instantiate))#line 315#line 316#line 317
    register_component ( reg,mkTemplate ( "Read Text File", None, low_level_read_text_file_instantiate))#line 318
    register_component ( reg,mkTemplate ( "Ensure String Datum", None, ensure_string_datum_instantiate))#line 319#line 320
    register_component ( reg,mkTemplate ( "syncfilewrite", None, syncfilewrite_instantiate))#line 321
    register_component ( reg,mkTemplate ( "String Concat", None, stringconcat_instantiate))#line 322
    register_component ( reg,mkTemplate ( "switch1*", None, switch1star_instantiate))#line 323
    register_component ( reg,mkTemplate ( "String Concat *", None, strcatstar_instantiate))#line 324
    # for fakepipe                                     #line 325
    register_component ( reg,mkTemplate ( "fakepipename", None, fakepipename_instantiate))#line 326#line 327#line 328
