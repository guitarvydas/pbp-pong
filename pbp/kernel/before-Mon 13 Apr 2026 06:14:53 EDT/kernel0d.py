...
def finalize (part):                                   #line 731
    print ( "finalize A", file=sys.stderr)             #line 732
    print (deque_to_json ( part.outq))                 #line 733
    print ( "finalize B", file=sys.stderr)             #line 734
    if ( part.state ==  "failed"):                     #line 735
        print ( "finalize C", file=sys.stderr)         #line 736
        exit (1)                                       #line 737#line 738
    print ( "finalize D", file=sys.stderr)             #line 739#line 740#line 741

def new_datum_bang ():                                 #line 742
    d =  Datum ()                                      #line 743
    d.v =  "!"                                         #line 744
    d.clone =  lambda : obj_clone ( d)                 #line 745
    d.reclaim =  None                                  #line 746
    return  d                                          #line 747#line 748
