...
def finalize (part):                                   #line 731
    print (deque_to_json ( part.outq))                 #line 732
    if ( part.state ==  "failed"):                     #line 733
        exit (1)                                       #line 734#line 735#line 736#line 737

def new_datum_bang ():                                 #line 738
    d =  Datum ()                                      #line 739
    d.v =  "!"                                         #line 740
    d.clone =  lambda : obj_clone ( d)                 #line 741
    d.reclaim =  None                                  #line 742
    return  d                                          #line 743#line 744
...
def fail_with_error_handler (eh,mev):                  #line 297
    ...
    print ( s, file=sys.stderr)                        #line 301
                                                       #line 302
    parent.fail_with_error ( parent)                   #line 303
    eh.state =  "failed"                               #line 304#line 305#line 306

# all of the the built_in leaves are listed here       #line 307
# future: refactor this such that programmers can pick and choose which (lumps of) builtins are used in a specific project#line 308#line 309
def initialize_stock_components (reg):                 #line 310
    register_component ( reg,mkTemplate ( "1then2", None, deracer_instantiate))#line 311
    register_component ( reg,mkTemplate ( "1→2", None, deracer_instantiate))#line 312
    register_component ( reg,mkTemplate ( "trash", None, trash_instantiate))#line 313
    register_component ( reg,mkTemplate ( "🗑️", None, trash_instantiate))#line 314
    register_component ( reg,mkTemplate ( "🚫", None, stop_instantiate))#line 315
    register_component ( reg,mkTemplate ( "👎", None, fail_with_error_instantiate))#line 316#line 317#line 318
    register_component ( reg,mkTemplate ( "Read Text File", None, low_level_read_text_file_instantiate))#line 319
    register_component ( reg,mkTemplate ( "Ensure String Datum", None, ensure_string_datum_instantiate))#line 320#line 321
    register_component ( reg,mkTemplate ( "syncfilewrite", None, syncfilewrite_instantiate))#line 322
    register_component ( reg,mkTemplate ( "String Concat", None, stringconcat_instantiate))#line 323
    register_component ( reg,mkTemplate ( "switch1*", None, switch1star_instantiate))#line 324
    register_component ( reg,mkTemplate ( "String Concat *", None, strcatstar_instantiate))#line 325
    # for fakepipe                                     #line 326
    register_component ( reg,mkTemplate ( "fakepipename", None, fakepipename_instantiate))#line 327#line 328#line 329
